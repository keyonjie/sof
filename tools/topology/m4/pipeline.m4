...
# list of generic scheduling sources
define (SCHEDULE_INITIATOR_DMA, 0)
define (SCHEDULE_INITIATOR_TIMER, 1)
...
dnl W_PIPELINE(stream, period, priority, frames, core, platform, initiator)
define(`W_PIPELINE',
